...
public class EnrollmentInfoDto {
    ...
    private Long professorId; // userid가 교수인 경우의 필드
    private String professorName;
    private Long lectureId;
    private String lectureName;
    // 추가 필드 필요 시 확장 가능

    public EnrollmentInfoDto(User student, User professor, Lecture lecture, Enrollment enrollment) {
        this.Id = enrollment.getId();
        this.studentId = student.getId(); // 학번
        this.studentName = student.getName(); // 학생 이름
        this.professorId = professor.getId();
        this.professorName = professor.getName(); // 교수 이름
